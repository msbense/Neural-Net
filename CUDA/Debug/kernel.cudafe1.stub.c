...
void __device_stub__Z10FeedFowardPdS_S_S_i(double *__par0, double *__par1, double *__par2, double *__par3, int __par4){__cudaSetupArgSimple(__par0, 0U);__cudaSetupArgSimple(__par1, 4U);__cudaSetupArgSimple(__par2, 8U);__cudaSetupArgSimple(__par3, 12U);__cudaSetupArgSimple(__par4, 16U);__cudaLaunch(((char *)((void ( *)(double *, double *, double *, double *, int))FeedFoward)));}
...
#line 1 "Debug/kernel.cudafe1.stub.c"
void __device_stub__Z17AverageAndCorrectPdS_S_S_ii( double *__par0,  double *__par1,  double *__par2,  double *__par3,  int __par4,  int __par5) {  __cudaSetupArgSimple(__par0, 0U); __cudaSetupArgSimple(__par1, 4U); __cudaSetupArgSimple(__par2, 8U); __cudaSetupArgSimple(__par3, 12U); __cudaSetupArgSimple(__par4, 16U); __cudaSetupArgSimple(__par5, 20U); __cudaLaunch(((char *)((void ( *)(double *, double *, double *, double *, int, int))AverageAndCorrect))); }
